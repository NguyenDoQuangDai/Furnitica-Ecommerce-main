...
import { UsersManagementRedirectComponent } from './Components/users-management-redirect/users-management-redirect.component';
...
const routes: Routes = [
  ...
  { path: 'users-management', component: UsersManagementRedirectComponent},
